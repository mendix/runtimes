...
\{
   ...
   */
	...
	/**
	 * Import a json stream, map this stream to domain objects and store those object in the Mendix database.
	 * @param context the context.
	 * @param jsonStream the json stream to map and store.
	 * @param importMappingName name of the mapping from json to domain objects (as defined in the Mendix Modeler, e.g. "Orders.MyMapping").
	 * @param mappingParameter parameter object used during the mapping (optional)
	 * @param shouldValidate whether the json should be validated.
	 */
	public static void importJsonStream(IContext context, InputStream jsonStream, String importMappingName, IMendixObject mappingParameter, boolean shouldValidate)
	\{
		integration.importJsonStream(context, jsonStream, importMappingName, mappingParameter, shouldValidate);
	\}
	 ...
	 * @param importMappingName name of the mapping from json to domain objects (as defined in the Mendix Modeler, e.g. "Orders.MyMapping").
	 * @param mappingParameter parameter object used during the mapping (optional)
	 * @param storeResultInVariable whether to store the result of the json mapping in variable which will be returned by this method.
	 * @param hasListReturnValue indicates whether the return value of the json mapping is of type List.
	 * @param shouldValidate whether the json should be validated.
	 */
	public static Object importJsonStream(IContext context, InputStream jsonStream, String importMappingName, IMendixObject mappingParameter,
			boolean storeResultInVariable, boolean hasListReturnValue, boolean shouldValidate)
	\{
		return integration.importJsonStream(context, jsonStream, importMappingName, mappingParameter, storeResultInVariable, -1, hasListReturnValue, shouldValidate);
	\}
